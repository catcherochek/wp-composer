...
$has_button1 = is_active_sidebar( 'button-1' );
...
?>
		...
		<header id="site-header" class="header-footer-group" role="banner">
                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left">
                                <ul>
                                    ...
                                    <li><i class="fas fa-phone"></i>097781544</li>
			...
			<div class="header-inner section-inner header-sticky">
                ...
                <?php if ( $has_button1 ) { ?>
                    <div id="widget-menu" class="text-lg-right text-center">
                        <?php dynamic_sidebar( 'button-1' ); ?>
                    </div>
                <?php } ?>
