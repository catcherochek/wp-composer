        ...
        this.props.slides.map(function (slide, index) {
          return React.createElement(
            ...
            React.createElement(
              ...
              (typeof slide.linkname !== 'undefined')?React.createElement(
                'p',
                { className: 'slider__slide-readmore' },
                React.createElement(
					'a',
					{ className: 'slider__slide-readmore',href:slide.link,style:{boxSizing:'border-box',margin:0,padding:0,color:'#fff',textDecoration: 'none'} },
					slide.linkname
				)
              ):''
            ),
...
var slides = [{
  ...
  city: 'Title3',
  country: 'Description',
  img: 'wp-content/themes/monwesta/assets/images/back9.jpg'
}, {
  linkname:'go google',
  link: 'godogle.com',
  city: 'Title1',
  country: 'Ddescription',
  img: 'wp-content/themes/monwesta/assets/images/back10.jpg'
},{
  linkname:'go google',
  link: 'godogle.com',
  city: 'Title2',
  country: 'Ddescription3',
  img: 'wp-content/themes/monwesta/assets/images/back5.jpg'
}
];

ReactDOM.render(React.createElement(CitiesSlider, { slides: slides }), document.querySelector('#app-react'));