...
define('THUMBLIB_BASE_PATH_WRI', dirname(__FILE__));
define('THUMBLIB_PLUGIN_PATH_WRI', THUMBLIB_BASE_PATH_WRI . '/thumb_plugins/');
define('DEFAULT_THUMBLIB_IMPLEMENTATION_WRI', 'gd');

/**
 * Include the PhpThumb Class
 */
require_once THUMBLIB_BASE_PATH_WRI . '/PhpThumbWRI.inc.php';
/**
 * Include the ThumbBase Class
 */
require_once THUMBLIB_BASE_PATH_WRI . '/ThumbBaseWRI.inc.php';
/**
 * Include the GdThumb Class
 */
require_once THUMBLIB_BASE_PATH_WRI . '/GdThumbWRI.inc.php';
...
class PhpThumbFactoryWRI
{
	 ...
	 * @var string
	 */
	public static $defaultImplemenation = DEFAULT_THUMBLIB_IMPLEMENTATION_WRI;
	/**
	 ...
	 * @var string
	 */
	public static $pluginPath = THUMBLIB_PLUGIN_PATH_WRI;
